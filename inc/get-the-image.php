 ...
 */
function IGIT_igitwid_get_the_image( $args = array() ) {
	global $post;
 ...
 * @return array|bool
 */
function IGIT_igitwid_image_by_custom_field( $args = array() ) {
 ...
 * @return array|bool
 */
function IGIT_igitwid_image_by_the_post_thumbnail( $args = array() ) {
 ...
 * @return array|bool
 */
function IGIT_igitwid_image_by_attachment( $args = array() ) {
 ...
 * @return array|bool
 */
function IGIT_igitwid_image_by_scan( $args = array() ) {
 ...
 * @return array
 */
function IGIT_igitwid_image_by_default( $args = array() ) {
 ...
 */
function IGIT_igitwid_display_the_image( $args = array(), $image = false ) {
 ...
 * @since 0.5
 */
function IGIT_igitwid_get_the_image_delete_cache() {
 ...
 * @deprecated 0.3
 */
function IGIT_igitwid_get_the_image_link( $deprecated = '', $deprecated_2 = '', $deprecated_3 = '' ) {
	IGIT_get_the_image();
}
